<?php /* Smarty version 3.1.28-dev/54, created on 2016-11-25 17:29:51
         compiled from "/mnt/hgfs/linux/IhponeServer_cgame/views/Data/DfromReport.html" */ ?>
<?php
/*%%SmartyHeaderCode:15590251165838048f88b389_30059574%%*/
$_valid = $_smarty_tpl->decodeProperties(array (
  'has_nocache_code' => false,
  'version' => '3.1.28-dev/54',
  'unifunc' => 'content_5838048f92bbb0_15535470',
  'file_dependency' => 
  array (
    '5c9ebfb25d70e93e1974c786e57fbac0d25002cf' => 
    array (
      0 => '/mnt/hgfs/linux/IhponeServer_cgame/views/Data/DfromReport.html',
      1 => 1473401046,
      2 => 'file',
    ),
...
/*/%%SmartyHeaderCode%%*/
if ($_valid && !is_callable('content_5838048f92bbb0_15535470')) {
function content_5838048f92bbb0_15535470 ($_smarty_tpl) {
ob_start();
$_smarty_tpl->compiled->nocache_hash = '15590251165838048f88b389_30059574';
?>

<?php 
$_smarty_tpl->_Block->registerBlock($_smarty_tpl, array('caching' => false, 'function' => 'block_function_bbb_9593276965838048f8c3869_36833972', 'name' => 'bbb'));
ob_end_clean();
/*  Call merged included template "Admin/index.html" */
$_smarty_tpl->_Inline->renderInline($_smarty_tpl, 'Admin/index.html', $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, 0, $_smarty_tpl->cache_lifetime, array(), 1, false, false, 'content_5838048f8ca4e4_29093034', '3ec737df16ee686e2f80964f4237a248f38b0420');
...
if ($_valid && !is_callable('content_5838048f8ca4e4_29093034')) {
function content_5838048f8ca4e4_29093034 ($_smarty_tpl) {
?>
<?php
$_smarty_tpl->compiled->nocache_hash = '15590251165838048f88b389_30059574';
?>
...
,欢迎</div>
    ...
    <div class="indexCenter">
        ...
        <div class="right">
            <?php 
$_smarty_tpl->_Block->callBlock($_smarty_tpl, array('caching' => false, 'function' => 'block_function_bbb_9914743185838048f918556_97385209', 'name' => 'bbb'));
?>
...
/*/%%SmartyNocache:15590251165838048f88b389_30059574%%*/
}
}
?><?php
/* block_function_bbb_9593276965838048f8c3869_36833972  file:Data/DfromReport.html */
if (!function_exists('block_function_bbb_9593276965838048f8c3869_36833972')) {
function block_function_bbb_9593276965838048f8c3869_36833972($_smarty_tpl, $block) {?>
<?php echo '<script'; ?>
...
?>
        ...
        <span>渠道*</span>
        <select class="fromId">
            <option value="0" <?php if ($_smarty_tpl->tpl_vars['serverIndex']->value == 0) {?>selected<?php }?>>选择渠道</option>
            <?php
$_from = $_smarty_tpl->tpl_vars['fromInfo_cl']->value;
if (!is_array($_from) && !is_object($_from)) {
settype($_from, 'array');
}
...
" <?php if ($_smarty_tpl->tpl_vars['showFromId']->value == $_smarty_tpl->tpl_vars['key']->value) {?>selected<?php }?>><?php echo $_smarty_tpl->tpl_vars['vv']->value;?>
</option>
            <?php
...
">
    ...
    <div class="ReportData">
        <div class="ReportDataTitle">
            ...
            <div class="ReportDataTitle_list">当日进入人数</div>
            <div class="ReportDataTitle_list">充值总人数</div>
            <div class="ReportDataTitle_list">充值总金额</div>
            <div class="ReportDataTitle_list">总转化率</div>
            <div class="ReportDataTitle_list">总ARPU</div>
            <div class="ReportDataTitle_list">总ARRPU</div>
            <div class="ReportDataTitle_list">活跃比例</div>
...
?>
               <div class="ReportDataCenter">
                    ...
                    <div class="ReportDataCenter_list"><?php echo $_smarty_tpl->tpl_vars['vv']->value['fromUserNum'];?>
</div>
                    <div class="ReportDataCenter_list"><?php echo $_smarty_tpl->tpl_vars['vv']->value['payUserNum'];?>
</div>
                    <div class="ReportDataCenter_list"><?php echo $_smarty_tpl->tpl_vars['vv']->value['payAmount'];?>
</div>
                    <div class="ReportDataCenter_list"></div>
                    <div class="ReportDataCenter_list"><?php echo $_smarty_tpl->tpl_vars['vv']->value['dayARPU'];?>
</div>
                    <div class="ReportDataCenter_list"></div>
                </div>
            <?php
...
';
    $(function(){
        ...
        $(".selectDiv_submit").click(function(){
            ...
            if(serverIndex && startDay && endDay && fromId){
                $(this).html('发送中...');
                $(this).css({"background":"#616161"});
                $.get("/DfromReportGet/",{"serverIndex":serverIndex,"startDay":startDay,"endDay":endDay,'class':className,'fromId':fromId,"doingUnid":new Date().getTime()},function(data){
                    var obj = jQuery.parseJSON(data);
                    if(obj.status!=2000){
                        alert(obj.message)
                    }
...
/*/ block_function_bbb_9593276965838048f8c3869_36833972 */
?>
<?php
/* block_function_bbb_9914743185838048f918556_97385209  file:Admin/index.html */
if (!function_exists('block_function_bbb_9914743185838048f918556_97385209')) {
function block_function_bbb_9914743185838048f918556_97385209($_smarty_tpl, $block) {?>
...
/*/ block_function_bbb_9914743185838048f918556_97385209 */
?>
