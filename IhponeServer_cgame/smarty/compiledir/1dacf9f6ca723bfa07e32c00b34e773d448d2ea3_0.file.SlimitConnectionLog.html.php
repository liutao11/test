<?php /* Smarty version 3.1.28-dev/54, created on 2016-11-25 16:13:43
         compiled from "/mnt/hgfs/linux/IhponeServer_cgame/views/Service/SlimitConnectionLog.html" */ ?>
<?php
/*%%SmartyHeaderCode:16587066685837f2b7993742_03664854%%*/
$_valid = $_smarty_tpl->decodeProperties(array (
  'has_nocache_code' => false,
  'version' => '3.1.28-dev/54',
  'unifunc' => 'content_5837f2b7b64d04_56939733',
  'file_dependency' => 
  array (
    '1dacf9f6ca723bfa07e32c00b34e773d448d2ea3' => 
    array (
      0 => '/mnt/hgfs/linux/IhponeServer_cgame/views/Service/SlimitConnectionLog.html',
      1 => 1480061613,
      2 => 'file',
    ),
...
/*/%%SmartyHeaderCode%%*/
if ($_valid && !is_callable('content_5837f2b7b64d04_56939733')) {
function content_5837f2b7b64d04_56939733 ($_smarty_tpl) {
ob_start();
$_smarty_tpl->compiled->nocache_hash = '16587066685837f2b7993742_03664854';
?>

<?php 
$_smarty_tpl->_Block->registerBlock($_smarty_tpl, array('caching' => false, 'function' => 'block_function_bbb_14766988875837f2b7a9c196_58690731', 'name' => 'bbb'));
ob_end_clean();
/*  Call merged included template "Admin/index.html" */
$_smarty_tpl->_Inline->renderInline($_smarty_tpl, 'Admin/index.html', $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, 0, $_smarty_tpl->cache_lifetime, array(), 1, false, false, 'content_5837f2b7aac404_17004081', '3ec737df16ee686e2f80964f4237a248f38b0420');
...
if ($_valid && !is_callable('content_5837f2b7aac404_17004081')) {
function content_5837f2b7aac404_17004081 ($_smarty_tpl) {
?>
<?php
$_smarty_tpl->compiled->nocache_hash = '16587066685837f2b7993742_03664854';
?>
...
,欢迎</div>
    ...
    <div class="indexCenter">
        ...
        <div class="right">
            <?php 
$_smarty_tpl->_Block->callBlock($_smarty_tpl, array('caching' => false, 'function' => 'block_function_bbb_9947568125837f2b7b49c44_32968850', 'name' => 'bbb'));
?>
...
/*/%%SmartyNocache:16587066685837f2b7993742_03664854%%*/
}
}
?><?php
/* block_function_bbb_14766988875837f2b7a9c196_58690731  file:Service/SlimitConnectionLog.html */
if (!function_exists('block_function_bbb_14766988875837f2b7a9c196_58690731')) {
function block_function_bbb_14766988875837f2b7a9c196_58690731($_smarty_tpl, $block) {?>
<?php echo '<script'; ?>
...
?>
                <div class="ReportDataCenter">
                    <div class="ReportDataCenter_list"><?php echo $_smarty_tpl->tpl_vars['vv']->value['ipUrl'];?>
</div>
                    <div class="ReportDataCenter_list"><?php echo $_smarty_tpl->tpl_vars['vv']->value['serverIndex'];?>
</div>
                    <div class="ReportDataCenter_list"><?php if ($_smarty_tpl->tpl_vars['vv']->value['setType'] == 1) {?>禁止<?php } else { ?>解禁<?php }?></div>
                    <div class="ReportDataCenter_list"><?php echo $_smarty_tpl->tpl_vars['vv']->value['CTime'];?>
</div>
                    <div class="ReportDataCenter_list"><?php echo $_smarty_tpl->tpl_vars['vv']->value['userName'];?>
</div>
                    <div class="ReportDataCenter_list"><?php if ($_smarty_tpl->tpl_vars['vv']->value['sendStatus'] == 0) {?>成功<?php } else { ?>失败<?php }?></div>
                    <div class="ReportDataCenter_list" style="width: 300px;overflow:hidden"><?php echo $_smarty_tpl->tpl_vars['vv']->value['message'];?>
</div>
...
/*/ block_function_bbb_14766988875837f2b7a9c196_58690731 */
?>
<?php
/* block_function_bbb_9947568125837f2b7b49c44_32968850  file:Admin/index.html */
if (!function_exists('block_function_bbb_9947568125837f2b7b49c44_32968850')) {
function block_function_bbb_9947568125837f2b7b49c44_32968850($_smarty_tpl, $block) {?>
...
/*/ block_function_bbb_9947568125837f2b7b49c44_32968850 */
?>
