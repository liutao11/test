<?php /* Smarty version 3.1.28-dev/54, created on 2016-11-25 17:30:01
         compiled from "/mnt/hgfs/linux/IhponeServer_cgame/views/Data/RealTime.html" */ ?>
<?php
/*%%SmartyHeaderCode:17046087655838049920a794_34348195%%*/
$_valid = $_smarty_tpl->decodeProperties(array (
  'has_nocache_code' => false,
  'version' => '3.1.28-dev/54',
  'unifunc' => 'content_5838049930d006_58339189',
  'file_dependency' => 
  array (
    '5fa32c621ef4427f9156955ef6736140a2d9c642' => 
    array (
      0 => '/mnt/hgfs/linux/IhponeServer_cgame/views/Data/RealTime.html',
      1 => 1473401385,
      2 => 'file',
    ),
...
/*/%%SmartyHeaderCode%%*/
if ($_valid && !is_callable('content_5838049930d006_58339189')) {
function content_5838049930d006_58339189 ($_smarty_tpl) {
ob_start();
$_smarty_tpl->compiled->nocache_hash = '17046087655838049920a794_34348195';
?>

<?php 
$_smarty_tpl->_Block->registerBlock($_smarty_tpl, array('caching' => false, 'function' => 'block_function_bbb_3759345655838049925f794_47607129', 'name' => 'bbb'));
ob_end_clean();
/*  Call merged included template "Admin/index.html" */
$_smarty_tpl->_Inline->renderInline($_smarty_tpl, 'Admin/index.html', $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, 0, $_smarty_tpl->cache_lifetime, array(), 1, false, false, 'content_5838049926b523_18644895', '3ec737df16ee686e2f80964f4237a248f38b0420');
...
if ($_valid && !is_callable('content_5838049926b523_18644895')) {
function content_5838049926b523_18644895 ($_smarty_tpl) {
?>
<?php
$_smarty_tpl->compiled->nocache_hash = '17046087655838049920a794_34348195';
?>
...
,欢迎</div>
    ...
    <div class="indexCenter">
        ...
        <div class="right">
            <?php 
$_smarty_tpl->_Block->callBlock($_smarty_tpl, array('caching' => false, 'function' => 'block_function_bbb_682045241583804992ef105_15708394', 'name' => 'bbb'));
?>
...
/*/%%SmartyNocache:17046087655838049920a794_34348195%%*/
}
}
?><?php
/* block_function_bbb_3759345655838049925f794_47607129  file:Data/RealTime.html */
if (!function_exists('block_function_bbb_3759345655838049925f794_47607129')) {
function block_function_bbb_3759345655838049925f794_47607129($_smarty_tpl, $block) {?>
<?php echo '<script'; ?>
...
>
    ...
    var option = {
        ...
        xAxis: [{type: 'category', boundaryGap: false, data: <?php echo $_smarty_tpl->tpl_vars['data_x']->value;?>
}],
        series: [
            {name:'实时在线',type:'line',smooth:false, symbol: 'none', stack: 'a', areaStyle: {normal: {}}, data: <?php echo $_smarty_tpl->tpl_vars['data_cl']->value;?>
}
        ]
    };
...
/*/ block_function_bbb_3759345655838049925f794_47607129 */
?>
<?php
/* block_function_bbb_682045241583804992ef105_15708394  file:Admin/index.html */
if (!function_exists('block_function_bbb_682045241583804992ef105_15708394')) {
function block_function_bbb_682045241583804992ef105_15708394($_smarty_tpl, $block) {?>
...
/*/ block_function_bbb_682045241583804992ef105_15708394 */
?>
