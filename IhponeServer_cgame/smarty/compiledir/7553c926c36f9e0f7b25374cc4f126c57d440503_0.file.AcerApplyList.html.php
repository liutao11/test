<?php /* Smarty version 3.1.28-dev/54, created on 2016-11-28 14:03:07
         compiled from "/mnt/hgfs/linux/IhponeServer_cgame/views/Operators/AcerApplyList.html" */ ?>
<?php
/*%%SmartyHeaderCode:585658097583bc89b627f90_07109314%%*/
$_valid = $_smarty_tpl->decodeProperties(array (
  'has_nocache_code' => false,
  'version' => '3.1.28-dev/54',
  'unifunc' => 'content_583bc89b737912_85338309',
  'file_dependency' => 
  array (
    '7553c926c36f9e0f7b25374cc4f126c57d440503' => 
    array (
      0 => '/mnt/hgfs/linux/IhponeServer_cgame/views/Operators/AcerApplyList.html',
      1 => 1480312983,
      2 => 'file',
    ),
...
/*/%%SmartyHeaderCode%%*/
if ($_valid && !is_callable('content_583bc89b737912_85338309')) {
function content_583bc89b737912_85338309 ($_smarty_tpl) {
ob_start();
$_smarty_tpl->compiled->nocache_hash = '585658097583bc89b627f90_07109314';
?>

<?php 
$_smarty_tpl->_Block->registerBlock($_smarty_tpl, array('caching' => false, 'function' => 'block_function_bbb_763463700583bc89b6b6151_64000370', 'name' => 'bbb'));
ob_end_clean();
/*  Call merged included template "Admin/index.html" */
$_smarty_tpl->_Inline->renderInline($_smarty_tpl, 'Admin/index.html', $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, 0, $_smarty_tpl->cache_lifetime, array(), 1, false, false, 'content_583bc89b6c2951_42101562', '3ec737df16ee686e2f80964f4237a248f38b0420');
...
if ($_valid && !is_callable('content_583bc89b6c2951_42101562')) {
function content_583bc89b6c2951_42101562 ($_smarty_tpl) {
?>
<?php
$_smarty_tpl->compiled->nocache_hash = '585658097583bc89b627f90_07109314';
?>
...
,欢迎</div>
    ...
    <div class="indexCenter">
        ...
        <div class="right">
            <?php 
$_smarty_tpl->_Block->callBlock($_smarty_tpl, array('caching' => false, 'function' => 'block_function_bbb_1562833450583bc89b724b82_66387971', 'name' => 'bbb'));
?>
...
/*/%%SmartyNocache:585658097583bc89b627f90_07109314%%*/
}
}
?><?php
/* block_function_bbb_763463700583bc89b6b6151_64000370  file:Operators/AcerApplyList.html */
if (!function_exists('block_function_bbb_763463700583bc89b6b6151_64000370')) {
function block_function_bbb_763463700583bc89b6b6151_64000370($_smarty_tpl, $block) {?>
<?php echo '<script'; ?>
...
</span> 平台->运营数据->元宝申请列表</div>
<div style="padding-top: 10px;">

    <div class="selectDiv">
        <span>服区*</span>
        <select class="serverIndex">
            <option value="0" <?php if ($_smarty_tpl->tpl_vars['serverIndex']->value == 0) {?>selected<?php }?>>全服务</option>
            <?php
...
">
    ...
    <div class="ReportData">
        ...
        <div class="ReportDataTitle">
            ...
            <div class="ReportDataTitle_list" style="width: 100px;">是否充值奖励</div>
            ...
            <div class="ReportDataTitle_list" >审核人</div>
...
?>
            <div class="ReportDataCenter" <?php if ($_smarty_tpl->tpl_vars['kk']->value > ($_smarty_tpl->tpl_vars['pagelength']->value-1)) {?> style="display: none"<?php }?>>
                ...
                <div class="ReportDataCenter_list" style="width: 100px;"><?php if ($_smarty_tpl->tpl_vars['vv']->value['state'] == 1) {?>未审核<?php } elseif ($_smarty_tpl->tpl_vars['vv']->value['state'] == 2) {?>通过<?php } elseif ($_smarty_tpl->tpl_vars['vv']->value['stata'] == 3) {?>未通过<?php } else { ?>未知状态<?php }?></div>
                ...
                <div class="ReportDataCenter_list" ><?php echo $_smarty_tpl->tpl_vars['vv']->value['inspectName'];?>
</div>
...
/*/ block_function_bbb_763463700583bc89b6b6151_64000370 */
?>
<?php
/* block_function_bbb_1562833450583bc89b724b82_66387971  file:Admin/index.html */
if (!function_exists('block_function_bbb_1562833450583bc89b724b82_66387971')) {
function block_function_bbb_1562833450583bc89b724b82_66387971($_smarty_tpl, $block) {?>
...
/*/ block_function_bbb_1562833450583bc89b724b82_66387971 */
?>
