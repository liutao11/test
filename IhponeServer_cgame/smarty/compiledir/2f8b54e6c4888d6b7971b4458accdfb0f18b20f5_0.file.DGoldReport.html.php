<?php /* Smarty version 3.1.28-dev/54, created on 2016-11-25 17:29:54
         compiled from "/mnt/hgfs/linux/IhponeServer_cgame/views/Data/DGoldReport.html" */ ?>
<?php
/*%%SmartyHeaderCode:803048682583804925d6ee6_05519401%%*/
$_valid = $_smarty_tpl->decodeProperties(array (
  'has_nocache_code' => false,
  'version' => '3.1.28-dev/54',
  'unifunc' => 'content_583804926683f1_96466368',
  'file_dependency' => 
  array (
    '2f8b54e6c4888d6b7971b4458accdfb0f18b20f5' => 
    array (
      0 => '/mnt/hgfs/linux/IhponeServer_cgame/views/Data/DGoldReport.html',
      1 => 1473401055,
      2 => 'file',
    ),
...
/*/%%SmartyHeaderCode%%*/
if ($_valid && !is_callable('content_583804926683f1_96466368')) {
function content_583804926683f1_96466368 ($_smarty_tpl) {
ob_start();
$_smarty_tpl->compiled->nocache_hash = '803048682583804925d6ee6_05519401';
?>

<?php 
$_smarty_tpl->_Block->registerBlock($_smarty_tpl, array('caching' => false, 'function' => 'block_function_bbb_236399283583804925faac0_15694293', 'name' => 'bbb'));
ob_end_clean();
/*  Call merged included template "Admin/index.html" */
$_smarty_tpl->_Inline->renderInline($_smarty_tpl, 'Admin/index.html', $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, 0, $_smarty_tpl->cache_lifetime, array(), 1, false, false, 'content_58380492601d32_43401419', '3ec737df16ee686e2f80964f4237a248f38b0420');
...
if ($_valid && !is_callable('content_58380492601d32_43401419')) {
function content_58380492601d32_43401419 ($_smarty_tpl) {
?>
<?php
$_smarty_tpl->compiled->nocache_hash = '803048682583804925d6ee6_05519401';
?>
...
,欢迎</div>
    ...
    <div class="indexCenter">
        ...
        <div class="right">
            <?php 
$_smarty_tpl->_Block->callBlock($_smarty_tpl, array('caching' => false, 'function' => 'block_function_bbb_278461348583804926544b3_12374421', 'name' => 'bbb'));
?>
...
/*/%%SmartyNocache:803048682583804925d6ee6_05519401%%*/
}
}
?><?php
/* block_function_bbb_236399283583804925faac0_15694293  file:Data/DGoldReport.html */
if (!function_exists('block_function_bbb_236399283583804925faac0_15694293')) {
function block_function_bbb_236399283583804925faac0_15694293($_smarty_tpl, $block) {?>
<?php echo '<script'; ?>
...
<style>
    ...
    .rolesTitle{font-size: 14px;line-height: 35px;height: 35px;}
    .rolesTitle span{font-weight: 600;color: #438EB9}

</style>

<div class="page_title"><span><?php echo $_smarty_tpl->tpl_vars['objectName']->value;?>
</span> 平台->运营数据->金币统计</div>
...
">
        <input type="text" class="roles" placeholder="未输入角色就是该区服数据">
        <div class="selectDiv_submit">提交</div>
    </div>

    <div class="ReportData">
        <?php if ($_smarty_tpl->tpl_vars['data']->value && $_smarty_tpl->tpl_vars['roles']->value) {?>
            <div class="rolesTitle">已下数据属于：<span><?php echo $_smarty_tpl->tpl_vars['roles']->value;?>
</span></div>

            <div class="ReportDataTitle">
                <div class="ReportDataTitle_list">日期</div>
                <div class="ReportDataTitle_list">金币初始</div>
                <div class="ReportDataTitle_list">金币截止</div>
                <div class="ReportDataTitle_list">获得金币</div>
                <div class="ReportDataTitle_list">消耗金币</div>
            </div>
...
?>
                   <div class="ReportDataCenter">
                        ...
                        <div class="ReportDataCenter_list"><?php echo $_smarty_tpl->tpl_vars['vv']->value['cs_sum'];?>
</div>
                        <div class="ReportDataCenter_list"><?php echo $_smarty_tpl->tpl_vars['vv']->value['yc_sum'];?>
</div>
                        <div class="ReportDataCenter_list"><?php echo $_smarty_tpl->tpl_vars['vv']->value['get_sum'];?>
</div>
                        <div class="ReportDataCenter_list"><?php echo $_smarty_tpl->tpl_vars['vv']->value['pop_sum'];?>
</div>
                    </div>
                <?php
...
?>
        ...
        <?php } else { ?>
            <div class="ReportDataTitle">
                <div class="ReportDataTitle_list">日期</div>
                <div class="ReportDataTitle_list">当日产出量</div>
                <div class="ReportDataTitle_list">当日消耗量</div>
            </div>
            <?php if ($_smarty_tpl->tpl_vars['data']->value) {?>
            <?php
$_from = $_smarty_tpl->tpl_vars['data']->value;
    ...
    $(function(){
        ...
        $(".selectDiv_submit").click(function(){
            ...
            if(serverIndex && startDay && endDay){
                ...
                $.get("/DGoldReportGet/",{"serverIndex":serverIndex,"startDay":startDay,"endDay":endDay,'class':className,"roles":roles,"doingUnid":new Date().getTime()},function(data){
                    var obj = jQuery.parseJSON(data);
                    if(obj.status!=2000){
                        alert(obj.message)
                    }
...
/*/ block_function_bbb_236399283583804925faac0_15694293 */
?>
<?php
/* block_function_bbb_278461348583804926544b3_12374421  file:Admin/index.html */
if (!function_exists('block_function_bbb_278461348583804926544b3_12374421')) {
function block_function_bbb_278461348583804926544b3_12374421($_smarty_tpl, $block) {?>
...
/*/ block_function_bbb_278461348583804926544b3_12374421 */
?>
