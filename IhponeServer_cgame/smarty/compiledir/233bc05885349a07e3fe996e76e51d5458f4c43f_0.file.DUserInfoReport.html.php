<?php /* Smarty version 3.1.28-dev/54, created on 2016-11-25 17:29:55
         compiled from "/mnt/hgfs/linux/IhponeServer_cgame/views/Data/DUserInfoReport.html" */ ?>
<?php
/*%%SmartyHeaderCode:71149001958380493ba3f94_02079982%%*/
$_valid = $_smarty_tpl->decodeProperties(array (
  'has_nocache_code' => false,
  'version' => '3.1.28-dev/54',
  'unifunc' => 'content_58380493e3cda2_91856850',
  'file_dependency' => 
  array (
    '233bc05885349a07e3fe996e76e51d5458f4c43f' => 
    array (
      0 => '/mnt/hgfs/linux/IhponeServer_cgame/views/Data/DUserInfoReport.html',
      1 => 1473401126,
      2 => 'file',
    ),
...
/*/%%SmartyHeaderCode%%*/
if ($_valid && !is_callable('content_58380493e3cda2_91856850')) {
function content_58380493e3cda2_91856850 ($_smarty_tpl) {
ob_start();
$_smarty_tpl->compiled->nocache_hash = '71149001958380493ba3f94_02079982';
?>

<?php 
$_smarty_tpl->_Block->registerBlock($_smarty_tpl, array('caching' => false, 'function' => 'block_function_bbb_74517761558380493da23f6_05224177', 'name' => 'bbb'));
ob_end_clean();
/*  Call merged included template "Admin/index.html" */
$_smarty_tpl->_Inline->renderInline($_smarty_tpl, 'Admin/index.html', $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, 0, $_smarty_tpl->cache_lifetime, array(), 1, false, false, 'content_58380493dbe510_50244134', '3ec737df16ee686e2f80964f4237a248f38b0420');
...
if ($_valid && !is_callable('content_58380493dbe510_50244134')) {
function content_58380493dbe510_50244134 ($_smarty_tpl) {
?>
<?php
$_smarty_tpl->compiled->nocache_hash = '71149001958380493ba3f94_02079982';
?>
...
,欢迎</div>
    ...
    <div class="indexCenter">
        ...
        <div class="right">
            <?php 
$_smarty_tpl->_Block->callBlock($_smarty_tpl, array('caching' => false, 'function' => 'block_function_bbb_66618116158380493e26807_58816717', 'name' => 'bbb'));
?>
...
/*/%%SmartyNocache:71149001958380493ba3f94_02079982%%*/
}
}
?><?php
/* block_function_bbb_74517761558380493da23f6_05224177  file:Data/DUserInfoReport.html */
if (!function_exists('block_function_bbb_74517761558380493da23f6_05224177')) {
function block_function_bbb_74517761558380493da23f6_05224177($_smarty_tpl, $block) {?>
<?php echo '<script'; ?>
...
?>
        ...
        <span>类型*</span>
        <select class="stayId">
            <option value="0" <?php if ($_smarty_tpl->tpl_vars['stayId']->value == 0) {?>selected<?php }?>>选择类型</option>
            <option value="1" <?php if ($_smarty_tpl->tpl_vars['stayId']->value == 1) {?>selected<?php }?>>职业分布</option>
            <option value="2" <?php if ($_smarty_tpl->tpl_vars['stayId']->value == 2) {?>selected<?php }?>>等级分布</option>
            <option value="3" <?php if ($_smarty_tpl->tpl_vars['stayId']->value == 3) {?>selected<?php }?>>VIP分布</option>
        </select>
        <span>日期*</span>
...
">
    ...
    <div class="ReportData">
        <?php if ($_smarty_tpl->tpl_vars['data']->value) {?>
            <?php if ($_smarty_tpl->tpl_vars['stayId']->value == 1) {?>
...
?>
                   <div class="ReportDataCenter">
                        <div class="ReportDataCenter_list"><?php echo $_smarty_tpl->tpl_vars['kk']->value;?>
</div>
                        <div class="ReportDataCenter_list"><?php echo $_smarty_tpl->tpl_vars['vv']->value['jobIndex0'];?>
</div>
                        <div class="ReportDataCenter_list"><?php echo $_smarty_tpl->tpl_vars['vv']->value['jobIndex1'];?>
</div>
                        <div class="ReportDataCenter_list"><?php echo $_smarty_tpl->tpl_vars['vv']->value['jobIndex2'];?>
</div>
                        <div class="ReportDataCenter_list"><?php echo $_smarty_tpl->tpl_vars['vv']->value['jobSum'];?>
</div>
                    </div>
                <?php
...
?>
            <?php } elseif ($_smarty_tpl->tpl_vars['stayId']->value == 2) {?>
                <div class="ReportDataTitle">
                    <div class="ReportDataTitle_list">日期</div>
...
?>
                <div class="ReportDataCenter">
                    ...
                    <div class="ReportDataCenter_list"><?php echo $_smarty_tpl->tpl_vars['vv']->value['group1'];?>
</div>
                    <div class="ReportDataCenter_list"><?php echo $_smarty_tpl->tpl_vars['vv']->value['group2'];?>
</div>
                    <div class="ReportDataCenter_list"><?php echo $_smarty_tpl->tpl_vars['vv']->value['group3'];?>
</div>
                    <div class="ReportDataCenter_list"><?php echo $_smarty_tpl->tpl_vars['vv']->value['group4'];?>
</div>
                    <div class="ReportDataCenter_list"><?php echo $_smarty_tpl->tpl_vars['vv']->value['group5'];?>
</div>
                    <div class="ReportDataCenter_list"><?php echo $_smarty_tpl->tpl_vars['vv']->value['group6'];?>
</div>
                    <div class="ReportDataCenter_list"><?php echo $_smarty_tpl->tpl_vars['vv']->value['group7'];?>
</div>
                    <div class="ReportDataCenter_list"><?php echo $_smarty_tpl->tpl_vars['vv']->value['group8'];?>
</div>
                    <div class="ReportDataCenter_list"><?php echo $_smarty_tpl->tpl_vars['vv']->value['group9'];?>
</div>
                    <div class="ReportDataCenter_list"><?php echo $_smarty_tpl->tpl_vars['vv']->value['group10'];?>
</div>
                </div>
                <?php
...
?>
            <?php } elseif ($_smarty_tpl->tpl_vars['stayId']->value == 3) {?>
                <div class="ReportDataTitle">
                    <div class="ReportDataTitle_list">日期</div>
...
?>
                <div class="ReportDataCenter">
                    ...
                    <div class="ReportDataCenter_list"><?php echo $_smarty_tpl->tpl_vars['vv']->value['1'];?>
</div>
                    <div class="ReportDataCenter_list"><?php echo $_smarty_tpl->tpl_vars['vv']->value['2'];?>
</div>
                    <div class="ReportDataCenter_list"><?php echo $_smarty_tpl->tpl_vars['vv']->value['3'];?>
</div>
                    <div class="ReportDataCenter_list"><?php echo $_smarty_tpl->tpl_vars['vv']->value['4'];?>
</div>
                    <div class="ReportDataCenter_list"><?php echo $_smarty_tpl->tpl_vars['vv']->value['5'];?>
</div>
                    <div class="ReportDataCenter_list"><?php echo $_smarty_tpl->tpl_vars['vv']->value['6'];?>
</div>
                    <div class="ReportDataCenter_list"><?php echo $_smarty_tpl->tpl_vars['vv']->value['7'];?>
</div>
                    <div class="ReportDataCenter_list"><?php echo $_smarty_tpl->tpl_vars['vv']->value['8'];?>
</div>
                    <div class="ReportDataCenter_list"><?php echo $_smarty_tpl->tpl_vars['vv']->value['9'];?>
</div>
                    <div class="ReportDataCenter_list"><?php echo $_smarty_tpl->tpl_vars['vv']->value['10'];?>
</div>
                    <div class="ReportDataCenter_list"><?php echo $_smarty_tpl->tpl_vars['vv']->value['11'];?>
</div>
                    <div class="ReportDataCenter_list"><?php echo $_smarty_tpl->tpl_vars['vv']->value['12'];?>
</div>
                    <div class="ReportDataCenter_list"><?php echo $_smarty_tpl->tpl_vars['vv']->value['13'];?>
</div>
                    <div class="ReportDataCenter_list"><?php echo $_smarty_tpl->tpl_vars['vv']->value['14'];?>
</div>
                    <div class="ReportDataCenter_list"><?php echo $_smarty_tpl->tpl_vars['vv']->value['15'];?>
</div>
                </div>
                <?php
...
/*/ block_function_bbb_74517761558380493da23f6_05224177 */
?>
<?php
/* block_function_bbb_66618116158380493e26807_58816717  file:Admin/index.html */
if (!function_exists('block_function_bbb_66618116158380493e26807_58816717')) {
function block_function_bbb_66618116158380493e26807_58816717($_smarty_tpl, $block) {?>
...
/*/ block_function_bbb_66618116158380493e26807_58816717 */
?>
