...
abstract class e_FromWorker extends worker{
    function GET_FUN(){
        ...
        if($cookie){
            ...
            if($rdresult_array['joinState'] && ($rdresult_array['groundId']==6 || $rdresult_array['groundId']==1 || $rdresult_array['groundId']==2)){
                ...
                $fromInfo=$rdresult_array['fromIdsName']?$rdresult_array['fromIdmName'].'-'.$rdresult_array['fromIdsName']:$rdresult_array['fromIdmName'];
