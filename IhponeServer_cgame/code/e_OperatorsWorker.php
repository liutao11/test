...
abstract class e_OperatorsWorker extends worker{
    function GET_FUN(){
        ...
        if($cookie){
            ...
            if($rdresult_array['joinState'] && ($rdresult_array['groundId']==4 || $rdresult_array['groundId']==1 || $rdresult_array['groundId']==2)){
